...
const About = () => {
  ...
  useEffect(() => {
    // runs when you navigate away from page
    return () => {
      window.__isAboutLoaded = true;
    };
  }, []);

  // runs animation only first time loading the page
  ...
  return (
    <BaseLayout user={data} loading={loading}>
      <BasePage title="About me - Popescu Daniel" className="about-page">
        <Row className="mt-5">
          <Col md="6">
          ...
          <Col md="6">
            <div className={`${createFadeInClass()}`}>
              <p>
                My name is Popescu Daniel and I am an experienced software
